...
', '', ''),
       (-3, '08:00', '17:00', true, false , '20.12.2021', 'Постоянно', 'Руководство одного из ведущих мировых сталелитейных предприятий инициировало проект «Создание системы внутреннего контроля за подготовкой финансовой отчетности с использованием решения Oracle Internal Controls Manager.', 'В рамках проекта по созданию Системы внутреннего контроля за подготовкой финансовой отчетности (СВКФО) на комбинате уже реализовано:
...
VALUES (-1, 'Чат-бот', 'Петров А.И.', 'МФЦ ', '15.02.2021', 'Середина', true, '2021-11-21T18:34:15.857Z', 'Внедрение автоматической системы для общения с пользователями', 'Государственное и муниципальное управление',
       ...
       (-2, '', 'Игорев П.С.', 'Минобрнауки России', '', 'Инициация', true, '2021-10-11T18:34:15.857Z', 'Внедрение экспертно-аналитической системы прогнозирования', 'Государственное и муниципальное управление',
        'Черновик', - 2, -2, -2),
       (-3, 'Система контроля', 'Сергеев В.И.', 'ММК', '13.02.2022', 'Завершение', true, '2021-12-01T18:34:15.857Z', 'Создание системы внутреннего контроля', 'Металлургия',
        'Активна', - 3, -3, -3),
       (-4, 'Торговая площадка', 'Сергеев В.И.', 'ММК', '10.04.2022', 'Начало', true, '2021-12-07T18:34:15.857Z', 'Создание портала поставщиков и электронной торговой площадки', 'Металлургия',
        'В архиве', - 4, -4, -4);

INSERT INTO project_technologies(id, technologies, project_card_id) VALUES
(-1, 'Python', -2),
(-2, 'SQL', -2),
(-3, 'UML', -2),
(-4, 'SOAP', -2),
